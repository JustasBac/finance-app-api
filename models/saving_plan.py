...
class SavingPlansModel(db.Model):
    ...
    start_date = db.Column(db.String(40), unique=False, nullable=False)
    end_date = db.Column(db.String(40), unique=False, nullable=False)
    starting_capital = db.Column(db.Float, unique=False, nullable=False)
    monthly_savings_list = db.relationship("MonthlySavingsModel", back_populates="saving_plan", cascade="all, delete") 
